...
@Component
public class CreateOpenBoothsByFoodBoothDTOBean {

    CreateBoothsByFoodBoothDTOBean createBoothsByFoodBoothDTOBean;

    @Autowired
    public CreateOpenBoothsByFoodBoothDTOBean(CreateBoothsByFoodBoothDTOBean createBoothsByFoodBoothDTOBean){
