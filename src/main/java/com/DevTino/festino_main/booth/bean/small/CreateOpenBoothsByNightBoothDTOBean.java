...
@Component
public class CreateOpenBoothsByNightBoothDTOBean {

    CreateBoothsByNightBoothDTOBean createBoothsByNightBoothDTOBean;

    @Autowired
    public CreateOpenBoothsByNightBoothDTOBean(CreateBoothsByNightBoothDTOBean createBoothsByNightBoothDTOBean){
