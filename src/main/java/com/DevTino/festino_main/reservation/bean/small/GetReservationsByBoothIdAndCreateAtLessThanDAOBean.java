...
public class GetReservationsByBoothIdAndCreateAtLessThanDAOBean {
    ...
    public List<ReservationDAO> exec(ReservationDAO reservationDAO) {
        return reservationRepositoryJPA.findAllByBoothIdAndReservationTypeAndCreateAtLessThan(reservationDAO.getBoothId(), ReservationEnum.RESERVE, reservationDAO.getCreateAt());
    }
}
