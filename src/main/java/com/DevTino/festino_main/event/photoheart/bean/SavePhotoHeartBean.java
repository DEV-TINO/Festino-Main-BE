...
public class SavePhotoHeartBean {
    ...
    @Autowired
    public SavePhotoHeartBean(GetPhotoHeartDAOBean getPhotoHeartDAOBean, CreatePhotoHeartDAOBean createPhotoHeartDAOBean, GetPhotoDAOBean getPhotoDAOBean, SavePhotoHeartDAOBean savePhotoHeartDAOBean, SavePhotoDAOBean savePhotoDAOBean) {
