...
public class PhotoController {
    ...
    public ResponseEntity<Map<String, Object>> getPhotos(@PathVariable("mainUserId") UUID mainUserId, @PathVariable("type") String type) {
        ...
        boolean success = responsePhotosGetDTO != null;

        // Map 이용해서 메시지와 id 값 json 데이터로 변환
        Map<String, Object> requestMap = new HashMap<>();
        requestMap.put("success", success);
        requestMap.put("message", success ? "사진 게시물 조회 성공" : "사진 게시물 조회 시 DAO 검색 실패");
        requestMap.put("photoInfo", responsePhotosGetDTO);
